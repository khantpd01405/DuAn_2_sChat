...
//
////            sharedPreferences.edit().putBoolean(UiMychat.SENT_TOKEN_TO_SERVER, true).apply();
//        } catch (Exception e) {
//            Log.e(TAG, "Failed to complete token refresh", e);
//
////            sharedPreferences.edit().putBoolean(UiMychat.SENT_TOKEN_TO_SERVER, false).apply();
//        }
//        // Notify UI that registration has completed, so the progress indicator can be hidden.
////        Intent registrationComplete = new Intent(UiMychat.REGISTRATION_COMPLETE);
